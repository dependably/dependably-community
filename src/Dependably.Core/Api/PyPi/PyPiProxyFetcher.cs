    ...
    ILogger<PyPiProxyFetcher> logger)
{
        ...
        FirstFetchArgs args, BlobHandle blob, ProxyContext gate, CancellationToken ct)
    {
        ...
        var result = await proxyFetch.RecordAndScanAsync(new ProxyFetchRequest(
            ...
            BlockKevRansomwareMode: gate.Settings.BlockKevRansomware,
            BlockSsvcExploitationMode: gate.Settings.BlockSsvcExploitation,
            MaxEpssPercentileTolerance: gate.Settings.MaxEpssPercentileTolerance,
