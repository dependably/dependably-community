...
#pragma warning restore S107
        ...
        TokenRecord? token, OrgSettings settings, CancellationToken ct)
    {
        ...
        try
        {
            ...
            var meta = await firstFetch.TryFetchAsync(upstreamSource, key.FullName, version, ct);
            ...
            var prov = await firstFetch.ResolveProvenanceAsync(settings, key.OrgId, key.FullName, version, meta, ct);
