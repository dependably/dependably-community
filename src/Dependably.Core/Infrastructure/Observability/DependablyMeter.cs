...
public static class DependablyMeter
{
    ...
    static DependablyMeter()
    {
        ...
        Meter.CreateObservableGauge(
            ...
            description: "Current count of tracked advisories (rows in the vulnerabilities catalog), grouped by ecosystem and severity " +
                "(severity 'unscored' when the advisory carries no CVSS classification). Updated by AdvisoryInventoryPoller.");
    }
