...
public sealed class InMemoryBlobStore : IBlobStore
{
    ...
    /// <summary>Test seam: snapshots the set of stored blob keys, for assertions on what was cached.</summary>
    public IReadOnlyCollection<string> GetKeys() => _blobs.Keys.ToArray();
