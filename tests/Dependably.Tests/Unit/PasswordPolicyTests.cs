...
public class PasswordPolicyTests
{
    ...
    {
        var r = PasswordPolicy.Evaluate(pwd, default);
    ...
    public void Evaluate_ContainsEmailLocalPart_ReturnsContainsContext()
    {
        ...
        var r = PasswordPolicy.Evaluate("AliceDevPassphrase!", ctx);
        Assert.Equal(PasswordPolicyVerdict.ContainsContext, r.Verdict);
    ...
    public void Evaluate_ShortEmailLocalPart_DoesNotTriggerContextMatch()
    {
        ...
        var r = PasswordPolicy.Evaluate("correct horse battery staple xyz", ctx);
    ...
    public void Evaluate_ContainsTenantSlug_ReturnsContainsContext()
    {
        ...
        var r = PasswordPolicy.Evaluate("AcmeCorpForever!!", ctx);
        Assert.Equal(PasswordPolicyVerdict.ContainsContext, r.Verdict);
    ...
    {
        var r = PasswordPolicy.Evaluate("correct horse battery staple xyz", default);
    ...
    public void Evaluate_UnicodeNormalization_MatchesContext()
    {
        ...
        var r = PasswordPolicy.Evaluate("CaféRoastersClub!", ctx);
        Assert.Equal(PasswordPolicyVerdict.ContainsContext, r.Verdict);
