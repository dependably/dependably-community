...
describe('endpoint contract', () => {
  ...
  const cases = [
    ...
    ['updateInstanceSettings', () => api.updateInstanceSettings({}), 'PUT', '/api/v1/instance/settings'],
    ...
    ['listCicdTokens', () => api.listCicdTokens(), 'GET', '/api/v1/cicd-tokens'],
    ['createCicdToken', () => api.createCicdToken('n', ['read:metadata'], null), 'POST', '/api/v1/cicd-tokens'],
    ['deleteCicdToken', () => api.deleteCicdToken('id'), 'DELETE', '/api/v1/cicd-tokens/id'],
